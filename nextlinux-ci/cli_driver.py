...
##################################################################
"""
Test Nextlinux by exercising various of the nextlinux-cli commands.
...
def account_add(context, name, email, test_type="positive", log=True):
    ...
    try:
        ...
        if log:
            ...
            logger.error("account_add | error calling nextlinux-cli: {0}".format(e))
...
def account_get(context, name, test_type="positive"):
    ...
    try:
        ...
        logger.error("account_get | error calling nextlinux-cli: {0}".format(e))
...
def account_disable(context, name, test_type="positive"):
    ...
    try:
        ...
        logger.error("account_disable | error calling nextlinux-cli: {0}".format(e))
...
def account_enable(context, name, test_type="positive"):
    ...
    try:
        ...
        logger.error("account_enable | error calling nextlinux-cli: {0}".format(e))
...
def account_del(context, name, test_type="positive"):
    ...
    try:
        ...
        if isinstance(e, subprocess.CalledProcessError):
            ...
            logger.error("account_del | error calling nextlinux-cli: {0}".format(e))
        ...
        if isinstance(e, subprocess.CalledProcessError):
            ...
            if account_override:
                if response == "Unauthorized" or response.get("httpcode") == 403:
                    ...
                    logger.error(
                        "account_list | error calling nextlinux-cli: {0}".format(e)
                    )
        else:
            log_explicit_failure(test_type, "account_list", "failed to list accounts")
            logger.error("account_list | error calling nextlinux-cli: {0}".format(e))
...
def account_user_list(context, test_type):
    ...
    try:
        ...
        logger.error("account_user_list | error calling nextlinux-cli: {0}".format(e))
    ...
    try:
        ...
        if isinstance(e, subprocess.CalledProcessError):
            ...
            if response == "Unauthorized" or response.get("httpcode") == 403:
                ...
                logger.error(
                    "account_user_list | error calling nextlinux-cli: {0}".format(e)
                )
        else:
            log_explicit_failure(
                test_type,
...
def account_user_add(context, account, username, userpass, test_type, log=True):
    ...
    try:
        ...
        if log:
            ...
            logger.error("account_user_add | error calling nextlinux-cli: {0}".format(e))
...
def account_user_del(context, test_type):
    ...
    try:
        ...
        logger.error("account_user_del | error calling nextlinux-cli: {0}".format(e))
...
def account_user_get(context, test_type):
    ...
    try:
        ...
        logger.error("account_user_get | error calling nextlinux-cli: {0}".format(e))
...
def account_user_setpassword(context, test_type):
    ...
    try:
        ...
        logger.error(
            "account_user_setpassword | error calling nextlinux-cli: {0}".format(e)
        )
...
def account_whoami(context, test_type="positive"):
    ...
    try:
        ...
        logger.error("account_whoami | error calling nextlinux-cli: {0}".format(e))
...
def image_add(context, test_type="positive"):
    ...
    for image in config.test_images + config.malware_images + config.clean_images:
        ...
        try:
            ...
            logger.error("image_add | error calling nextlinux-cli: {0}".format(e))
...
def image_del(context, force=False, test_type="positive"):
    ...
    try:
        ...
        if isinstance(e, subprocess.CalledProcessError):
            ...
            logger.error("image_del | error calling nextlinux-cli: {0}".format(e))
...
def image_get(context, test_type="positive", return_images=False, log=True):
    ...
    for image in config.test_images:
        ...
        try:
            ...
            logger.error("image_get | error calling nextlinux-cli: {0}".format(e))
    if return_images:
        if log:
...
def image_list(context, test_type="positive"):
    ...
    try:
        ...
        logger.error("image_list | error calling nextlinux-cli: {0}".format(e))
...
def image_metadata(context, test_type="positive"):
    ...
    try:
        ...
        logger.error("image_metadata | error calling nextlinux-cli: {0}".format(e))
...
def image_vuln(context, test_type="positive"):
    ...
    try:
        ...
        logger.error("image_vuln | error calling nextlinux-cli: {0}".format(e))
...
def repo_add(context, test_type="positive"):
    ...
    for repo in config.repositories:
        ...
        try:
            ...
            logger.error("repo_add | error calling nextlinux-cli: {0}".format(e))
...
def repo_del(context, test_type="positive"):
    ...
    try:
        ...
        logger.error("repo_del | error calling nextlinux-cli: {0}".format(e))
...
def repo_get(context, test_type="positive"):
    ...
    for repo in config.repositories:
        ...
        try:
            ...
            logger.error("repo_get | error calling nextlinux-cli: {0}".format(e))
    logger.info("repo_get | finished")
...
def repo_list(context, test_type="positive"):
    ...
    try:
        ...
        logger.error("repo_list | error calling nextlinux-cli: {0}".format(e))
...
def repo_unwatch(context, test_type="positive"):
    ...
    try:
        ...
        logger.error("repo_unwatch | error calling nextlinux-cli: {0}".format(e))
...
def repo_watch(context, test_type="positive"):
    ...
    try:
        ...
        logger.error("repo_watch | error calling nextlinux-cli: {0}".format(e))
...
def subscription_get_one(context):
    ...
    try:
        ...
        logger.error("subscription_get_one | error calling nextlinux-cli: {0}".format(e))
...
def subscription_list(context, test_type="positive"):
    ...
    try:
        ...
        logger.error("subscription_list | error calling nextlinux-cli: {0}".format(e))
...
def subscription_activate(context, test_type="positive"):
    ...
    try:
        ...
        logger.error("subscription_activate | error calling nextlinux-cli: {0}".format(e))
...
def subscription_deactivate(context, test_type="positive"):
    ...
    try:
        ...
        logger.error(
            "subscription_deactivate | error calling nextlinux-cli: {0}".format(e)
        )
...
def system_feeds_config_toggle(context, test_type="positive", enable=True):
    ...
    try:
        ...
        logger.error(
            "system_feeds_config_toggle | error calling nextlinux-cli: {0}".format(e)
        )
...
def system_feeds_delete(context, test_type="positive"):
    ...
    try:
        ...
        logger.error("system_feeds_delete | error calling nextlinux-cli: {0}".format(e))
...
def system_feeds_list(context, test_type="positive", return_feeds=False, log=True):
    ...
    try:
        ...
        if log:
            ...
            logger.error("system_feeds_list | error calling nextlinux-cli: {0}".format(e))
        return
...
def system_status(context, test_type="positive"):
    ...
    try:
        ...
        logger.error("system_status | error calling nextlinux-cli: {0}".format(e))
...
def system_errorcodes(context, test_type="positive"):
    ...
    try:
        ...
        logger.error("system_errorcodes | error calling nextlinux-cli: {0}".format(e))
    ...
    try:
        ...
        if isinstance(e, subprocess.CalledProcessError):
            ...
            if response.get("message") == "registry already exists in DB":
                ...
                logger.error("registry_add | error calling nextlinux-cli: {0}".format(e))
...
def registry_get(context, test_type="positive"):
    ...
    try:
        ...
        logger.error("registry_get | error calling nextlinux-cli: {0}".format(e))
...
def registry_list(context, test_type="positive"):
    ...
    try:
        ...
        logger.error("registry_list | error calling nextlinux-cli: {0}".format(e))
...
def registry_del(context, test_type="positive"):
    ...
    try:
        ...
        logger.error("registry_del | error calling nextlinux-cli: {0}".format(e))
