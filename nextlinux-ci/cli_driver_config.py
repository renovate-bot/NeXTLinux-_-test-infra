...
cmd_prefix = "nextlinux-cli --json "

cli_command_prefix = "kubectl exec nextlinux-cli -- "

local_url = "http://localhost:8228/v1"

ci_url = "http://e2e-testing-nextlinux-engine-api:8228/v1"
...
malware_images = ["docker.io/nextlinux/test_images:alpine_malware_test"]

clean_images = ["docker.io/nextlinux/test_images:alpine_clean"]
